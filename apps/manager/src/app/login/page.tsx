...
const loginFormSchema = z.object({
  email: z.string().email({ message: '아이디는 이메일 형식으로 입력해주세요.' }),
  password: z.string().min(4, { message: '비밀번호는 8글자 이상이어야 합니다.' }),
});
  ...
  return (
    <Layout headerVisible={false} navigationVisible={false}>
      <div className={styles.loginLayout}>
        ...
        <Form {...methods}>
          <form className={styles.form} onSubmit={methods.handleSubmit(onSubmit, handleError)}>
            <FormField
