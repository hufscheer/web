...
import { getProgressTypeByQuarter, QUARTER_ID, QUARTER_KEY, QUARTERS_DB } from '@/constants/games';

import * as styles from './styles.css';
import { progressDefaultValues, progressFormSchema, ProgressFormSchema } from '../../_types';
...
const ProgressForm = ({ gameId, onClose }: ProgressFormProps) => {
  ...
  const { mutate: createProgressTimelineMutation, isPending } = useCreateProgressTimeline();
    ...
    createProgressTimelineMutation(
      {
        ...
        gameProgressType: getProgressTypeByQuarter(data.recordedQuarterId as QUARTER_KEY),
      },
      {
        onSuccess: () => {
          methods.reset();
