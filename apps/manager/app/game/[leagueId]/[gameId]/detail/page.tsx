...
export default function GameDetail() {
  ...
  const handleEdit = () => {
    ...
    const payload: GameUpdatePayload = {
      sportsId: Number(form.values.sportsId),
      gameName: form.values.gameName,
      videoId: form.values.videoId || null,
      round: Number(form.values.round),
      startTime: form.values.startTime.toISOString(),
      gameQuarter: form.values.gameQuarter,
      state: form.values.state as 'playing' | 'scheduled' | 'finished',
    };
