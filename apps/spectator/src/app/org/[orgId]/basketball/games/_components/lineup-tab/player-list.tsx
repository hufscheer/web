              ...
              >
                ...
                <span>
                  {player.isCaptain && (
                    ...
                    >
                      <span className="translate-x-[1px] text-[10px] leading-none">C</span>
                    </span>
                  )}
                </span>

                <span className="center h-[22px] w-[28px]">
                  {player.position && (
                    <span className="center h-full w-full rounded-md bg-neutral-100 px-1 text-[11px] leading-none font-semibold text-neutral-900">
                      {player.position}
                    </span>
                  )}
                </span>
