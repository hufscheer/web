    ...
    <Fragment>
      ...
      <Accordion type="single" collapsible>
        <AccordionItem value="candidate">
          <AccordionTrigger className={styles.candidateButton}>후보 선수 보기</AccordionTrigger>
          <AccordionContent>
            <div className={clsx(styles.container, styles.candidateContainer)}>
              <PlayerList players={homeTeam.candidatePlayers} direction={homeTeam.direction} />
              <div className={styles.divider} />
              <PlayerList players={awayTeam.candidatePlayers} direction={awayTeam.direction} />
            </div>
          </AccordionContent>
        </AccordionItem>
      </Accordion>
