...
export type GenericRecordType<T extends 'SCORE' | 'REPLACEMENT'> = CommonRecordType & {
  type: T;
  scoreRecord: T extends 'SCORE' ? ScoreRecord : null;
  replacementRecord: T extends 'REPLACEMENT' ? ReplacementRecord : null;
};

export type GameRecordType = GenericRecordType<'SCORE'> | GenericRecordType<'REPLACEMENT'>;
...
export type GameCheerTalkPayload = Pick<GameCheerTalkType, 'gameTeamId' | 'content'>;
