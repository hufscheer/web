  ...
  return (
    <Dialog>
      <DialogTrigger className={styles.openIconButton}>
        <Icon source={HamburgerIcon} aria-label="메뉴 열기" role="button" color="black" size={24} />
      </DialogTrigger>
      <DialogPortal>
        <DialogOverlay />
        <DialogContent className={styles.sidebar} aria-label="sidebar" aria-describedby={undefined}>
